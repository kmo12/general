...
class ApiResponse:
    # TODO сюда можно добавлять методов для получения ответов, типа give_user_first_name и так далее
    @staticmethod
    def give_user_name(received_from_id: int) -> str:
        return vkApi.method("users.get", {"user_ids": received_from_id})
